...
class CairnClient:
    ...
    def create_hint(self, project_id: str, content: str, creator: str) -> ApiResult:
        return self._request_json(
            "POST", f"/projects/{project_id}/hints", json={"content": content, "creator": creator},
        )

    def stop_project(self, project_id: str) -> ApiResult:
        return self._request_json("PUT", f"/projects/{project_id}/status", json={"status": "stopped"})
