...
from cairn.terminal import project
from cairn.console import start
...
@click.option("--fd", type=int, default=None, hidden=True)
def serve(host: str, port: int, db_path: str, log_level: str, access_log: bool, fd: int | None):
